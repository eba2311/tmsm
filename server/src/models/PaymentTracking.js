...
const PaymentTracking = sequelize.define(
  'PaymentTracking',
  {
    ...
    currency: { type: DataTypes.ENUM('ETB', 'USD', 'EUR'), defaultValue: 'ETB' },
    method: {
    ...
    gatewayTransactionId:{ type: DataTypes.STRING },
    gatewayResponse:     { type: DataTypes.JSONB },
    metadata: {
      type: DataTypes.JSONB,
      defaultValue: {
        phoneNumber: null, cardLast4: null, cardBrand: null,
        bankName: null, accountNumber: null, receiptNumber: null, notes: null,
      },
    },
    timestampsInitiated: { type: DataTypes.DATE, defaultValue: DataTypes.NOW },
    timestampsCompleted: { type: DataTypes.DATE },
    timestampsFailed:    { type: DataTypes.DATE },
    timestampsRefunded:  { type: DataTypes.DATE },
