...
const Geofence = sequelize.define(
  'Geofence',
  {
    ...
    radius:             { type: DataTypes.DECIMAL(10, 2) },
    alertOnEntry:       { type: DataTypes.BOOLEAN, defaultValue: true },
    alertOnExit:        { type: DataTypes.BOOLEAN, defaultValue: true },
    assignedVehicleIds: { type: DataTypes.ARRAY(DataTypes.UUID), defaultValue: [] },
    assignedRouteIds:   { type: DataTypes.ARRAY(DataTypes.UUID), defaultValue: [] },
